...
You don't need to run `pnpm build` every time you make a change. Instead, use `pnpm watch` - this will auto-compile Rivercord whenever you make a change. If using code patches (recommended), you will need to CTRL+R to load the changes.
...
## How Plugins Work In Rivercord

Rivercord uses a different way of making mods than you're used to.
...
If you want to publish your plugin into the Rivercord repo, move your plugin from `src/userplugins` into the `src/plugins` folder and open a PR!
