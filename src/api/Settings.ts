...
const settings = !IS_REPORTER ? RivercordNative.settings.get() : {} as Settings;
...
if (!IS_REPORTER) {
    SettingsStore.addGlobalChangeListener((_, path) => {
        ...
        localStorage.Rivercord_settingsDirty = true;
        saveSettingsOnFrequentAction();
        RivercordNative.settings.set(SettingsStore.plain, path);
    });
}
