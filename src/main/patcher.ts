...
if (!IS_VANILLA) {
    ...
    class BrowserWindow extends electron.BrowserWindow {
        constructor(options: BrowserWindowConstructorOptions) {
            if (options?.webPreferences?.preload && options.title) {
                ...
                options.webPreferences.preload = join(__dirname, IS_DISCORD_DESKTOP ? "preload.js" : "rivercordDesktopPreload.js");
    ...
    process.env.DATA_DIR = join(app.getPath("userData"), "..", "Rivercord");
