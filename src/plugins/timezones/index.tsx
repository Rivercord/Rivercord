...
export default definePlugin({
    ...
    settingsAboutComponent: () => {
        const href = `${API_URL}?client_mod=${encodeURIComponent(RIVERCORD_USER_AGENT)}`;
        return (
    ...
    patches: [
        ...
        {
            // thank you https://github.com/Syncxv/rc-timezones/blob/master/index.tsx for saving me from painful work
