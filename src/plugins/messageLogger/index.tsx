    ...
    toggle: {
        ...
        children.push((
            <Menu.MenuItem
                ...
                label="Silinmiş Vurgulamayı Değiştir"
...
export default definePlugin({
    name: "MessageLogger",
    description: "Silinen ve düzenlenen mesajları geçici olarak geçmişe kaydeder.",
    ...
    options: {
        ...
        logDeletes: {
            ...
            description: "Silinen mesajlar geçmişe kaydedilsin.",
            default: true,
        },
        collapseDeleted: {
            type: OptionType.BOOLEAN,
        ...
        logEdits: {
            type: OptionType.BOOLEAN,
            description: "Düzenlenen mesajlar geçmişe kaydedilsin.",
            default: true,
        },
        inlineEdits: {
            type: OptionType.BOOLEAN,
            description: "Düzenleme geçmişinin mesaj içeriğinin bir parçası olarak görüntülensin",
            default: true
        },
        ignoreBots: {
            type: OptionType.BOOLEAN,
            description: "Botlar tarafından gönderilen mesajları umursama.",
            default: false
        },
        ignoreSelf: {
            type: OptionType.BOOLEAN,
            description: "Kendi yazdığınız mesajları umursamasın.",
            default: false
        },
        ignoreUsers: {
            type: OptionType.STRING,
            description: "Yoksayılacak Kullanıcıların ID numaraları.",
            default: ""
        },
        ignoreChannels: {
            type: OptionType.STRING,
            description: "Yoksayılacak Kanalların ID numaraları",
            default: ""
        },
        ignoreGuilds: {
            type: OptionType.STRING,
            description: "Yoksayılacak Sunucuların ID numaraları",
            default: ""
        },
    },
