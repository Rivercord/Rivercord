...
export default definePlugin({
    ...
    start() {
        ...
        if (settings.store.IconLocation === "chat") addChatBarButton("rc-soundlog-button", ChatBarIcon);
    },
    stop() {
        disableStyle(styles);
        if (settings.store.IconLocation === "chat") removeChatBarButton("rc-soundlog-button");
    },
    toolbarPatch: obj => {
