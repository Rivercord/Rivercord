...
const settings = definePluginSettings({
    ...
    showRivercordDonor: {
        type: OptionType.BOOLEAN,
        description: "Enable to show Rivercord Donor badges in chat.",
        hidden: true,
        default: true
    },
    RivercordDonorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Rivercord Donor badges.",
        hidden: true,
        default: 2
    },
    showRivercordContributor: {
        type: OptionType.BOOLEAN,
        description: "Enable to show Rivercord Contributor badges in chat.",
        hidden: true,
        default: true
    },
    RivercordContributorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Rivercord Contributor badge.",
        hidden: true,
        default: 3
    },
    showDiscordProfile: {
...
const BadgeSettings = () => {
    const [images, setImages] = useState([
        ...
        { src: "https://cdn.discordapp.com/emojis/1026533070955872337.png", shown: settings.store.showRivercordDonor, title: "Rivercord donor badges", key: "RivercordDonor", position: settings.store.RivercordDonorPosition },
        { src: "https://vencord.dev/assets/favicon.png", shown: settings.store.showRivercordContributor, title: "Rivercord contributor badge", key: "RivercordContributer", position: settings.store.RivercordContributorPosition },
        ...
        images.forEach(image => {
            switch (image.key) {
                ...
                case "SuncordContributer":
                    ...
                    break;
                case "RivercordDonor":
                    settings.store.RivercordDonorPosition = image.position;
                    settings.store.showRivercordDonor = image.shown;
                    break;
                case "RivercordContributer":
                    settings.store.RivercordContributorPosition = image.position;
                    settings.store.showRivercordContributor = image.shown;
                    break;
                case "DiscordProfile":
