...
const buildCss = () => {
    ...
    style.textContent = settings.store.showNotice ? `
        ...
        :is(${elements}) [id^='message-accessories'] > *:not(.rc-hide-message-accessory),
...
export const cl = classNameFactory("rc-hide-message-");
...
export default definePlugin({
    ...
    async start() {
        ...
        addAccessory("rc-hide-message", ({ message }) => {
    ...
    async stop() {
        ...
        removeAccessory("rc-hide-message");
