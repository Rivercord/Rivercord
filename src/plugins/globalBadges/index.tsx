...
const GlobalBadges = ({ userId }: { userId: string; }) => {
    ...
    return (
        <div className="rc-global-badges" style={{ alignItems: "center", display: "flex" }}>
            {globalBadges}
        </div>
    );
};
...
const showPrefix = () => Rivercord.Settings.plugins.GlobalBadges.showPrefix;
const showCustom = () => Rivercord.Settings.plugins.GlobalBadges.showCustom;
