...
export const NoteModal = (props: ModalProps & { onClose: () => void; }) => {
    ...
    return (
        <ErrorBoundary>
            <ModalRoot {...props} className={classes("rc-notebook")} size={ModalSize.LARGE}>
                <Flex className={classes("rc-notebook-flex")} direction={Flex.Direction.VERTICAL} style={{ width: "100%" }}>
                    <div className={classes("rc-notebook-top-section")}>
                        <ModalHeader className={classes("rc-notebook-header-main")}>
                            <Text
                                variant="heading-lg/semibold"
                                style={{ flexGrow: 1 }}
                                className={classes("rc-notebook-heading")}>
                                NOTEBOOK
                            </Text>
                            <div className={classes("rc-notebook-flex", "rc-help-icon")} onClick={() => openModal(HelpModal)}>
                                <HelpIcon />
                            </div>
                            <div style={{ marginBottom: "10px" }} className={classes("rc-notebook-search")}>
                                <TextInput
                                    autoFocus={false}
                        ...
                        <div className={classes("rc-notebook-tabbar-container")}>
                            {TabBar}
                        </div>
                    </div>
                ...
                <ModalFooter>
                    ...
                    <div className={classes("sort-button-container", "rc-notebook-display-left")}>
                        <Flex
