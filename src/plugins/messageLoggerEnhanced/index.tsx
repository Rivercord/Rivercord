...
export const settings = definePluginSettings({
    ...
    permanentlyRemoveLogByDefault: {
        default: false,
        type: OptionType.BOOLEAN,
        description: "Suncord's base MessageLogger remove log button wiil delete logs permanently",
    },
    ...
    patches: [
        ...
        // https://regex101.com/r/TMV1vY/1
        {
            ...
            replacement: {
                ...
                replace: "$1 let forceUpdate=Rivercord.Util.useForceUpdater();$self.patchAttachments($2,forceUpdate);$3"
            }
        },
