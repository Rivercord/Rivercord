# rc-message-logger-enhanced

## What is this?

This is a third-party-plugin for [Rivercord](https://vencord.dev/) that logs messages, images, and ghost pings in Discord.
...
https://github.com/Syncxv/rc-message-logger-enhanced/assets/47534062/31be3fcb-71db-4714-9d94-99b340371e96
...
-   Made update message less confusing https://github.com/Syncxv/rc-message-logger-enhanced/issues/2

## Version 1.3.1

-   Added option to always log Direct Messages by [@CatGirlDShadow](https://github.com/CatGirlDShadow) in https://github.com/Syncxv/rc-message-logger-enhanced/pull/1
-   Added option to always log Selected Channel by [@CatGirlDShadow](https://github.com/CatGirlDShadow) in https://github.com/Syncxv/rc-message-logger-enhanced/pull/1
-   Added option to ignore muted Categories by [@CatGirlDShadow](https://github.com/CatGirlDShadow) in https://github.com/Syncxv/rc-message-logger-enhanced/pull/1
-   Added option to ignore muted Channels by [@CatGirlDShadow](https://github.com/CatGirlDShadow) in https://github.com/Syncxv/rc-message-logger-enhanced/pull/1
...
https://github.com/Syncxv/rc-message-logger-enhanced/assets/47534062/de932bff-91fe-4825-8ef7-551cf245e51a
