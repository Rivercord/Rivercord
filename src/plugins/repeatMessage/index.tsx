...
function RepeatMessageIcon({ className }: { className?: string; }) {
    return (
        <svg
            ...
            height={24}
            width={24}
            className={classes(classNameFactory("rc-repeat-")("icon"), className)}
        >
...
function setTitle(title: string) {
    const contextMenuOption = document.querySelector("#message-rc-repeat .label__563c3");
