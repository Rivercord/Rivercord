...
export function PalleteIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "rc-pallete-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function CloseIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "rc-close-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function DownloadIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "rc-download-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function ImportIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "rc-import-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function IDIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "rc-id-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function CodeIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "rc-code-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
...
export function MoreIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "rc-more-icon")}
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
